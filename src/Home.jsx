  ...
  return (
    <div className="home-top mt-12 flex justify-around">
        <div>
            ...
            <form action='https://formspree.io/f/xlekdygk' method="POST" className="ale">
            ...
            <input type="submit" value="Join Waitlist" className="solana border border-2 px-8 py-4 bg-[#05acee] text-white rounded-lg border-white" />
            </form>
        </div>
        <div className="mr-20">
