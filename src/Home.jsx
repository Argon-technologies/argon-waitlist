  ...
  return (
    <div className="mt-12 flex justify-around">
        <div>
            ...
            <form>
            <input type="text" placeholder="Email Address" className="outline-none border border-2 border-white px-5 py-4 rounded-lg bg-blue-50" />
            <a href="#"><button className="border border-2 px-8 py-4 bg-[#05acee] text-white rounded-lg border-white">Join Waitlist</button></a>
            </form>
        </div>
        <div className="mr-20">
